...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLfloat radius1 = 6.0f;
		GLfloat camX1 = cos(glfwGetTime()) * radius1;
		GLfloat camZ1 = sin(glfwGetTime()) * radius1;
		GLfloat camY1 = sin(glfwGetTime()) * radius1;
		view = glm::lookAt(glm::vec3(camX1, camY1, camZ1), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
